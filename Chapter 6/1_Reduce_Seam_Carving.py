...
if __name__=='__main__':
    ...
    img_input = cv2.imread('D:/A LEARN/Image Processing/A Panduan Kang Gip/image/duck2.jpg')
    ...
    for i in range(num_seams):
        seam = find_vertical_seam(img, energy)  #find seam nya 
        img_overlay_seam = overlay_vertical_seam(img_overlay_seam, seam) #Draw aja
        img = remove_vertical_seam(img, seam)   #remove seam
        energy = compute_energy_matrix(img)        #compute energy fo next round
